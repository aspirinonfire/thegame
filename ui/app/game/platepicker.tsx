...
export const PlatePicker = ({ isShowPicker, setShowPicker, saveNewPlateData, plateData }: PickerControls) => {
  ...
  async function getPlatesMatchingAiSearch(query: string): Promise<TerritoryToRender[]> {
  ...
  function getQuickSearchResults(query: string | null | undefined): TerritoryToRender[] {
    if (!query) {
