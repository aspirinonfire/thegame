...
export default function UsMap(mapArguments: ActiveGameData | HistoricalGamesData) {
  if (!mapArguments) {
    return (<p className="text-black text-sm">awaiting map data...</p>);
  }
